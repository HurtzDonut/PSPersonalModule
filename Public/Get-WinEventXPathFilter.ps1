...
.EXAMPLE
    Get-WinEventXPathFilter -StartTime '1/1/2015 01:30:00 PM' -EndTime '1/1/2015 02:00:00 PM'F
...
.EXAMPLE
    ...
    Get-WinEventXPathFilter -StartTime (Get-Date).AddDays(-1) -ID 4624 -Data (@{'SubjectUserName'='vmmitchell'},@{'TargetUserName'='vmmitchell'})
#>
Function Get-WinEventXPathFilter {
    ...
    #region Function definitions
        Function Join-XPathFilter {
            ...
            If ($ExistingFilter) { 
                # If there is an existing filter add parenthesis
        ...
        Function Initialize-XPathFilter {
            ...
            Param (
                [Parameter()]
                    [Object[]]$Items,
                [Parameter()]
                    [String]$ForEachFormatString,
                [Parameter()]
                    [String]$FinalizeFormatString
            )
                                ...
                                ForEach ($key in $item.Keys) {
                                    If ($item[$key]) {
                                        ...
                                        $options = @{
                                            'Items'                = $item[$key]
                                            'ForEachFormatString'  = "Data='{0}'"
                                            'FinalizeFormatString' = "Data[@Name='$key'] and ({0})"
                                        }
